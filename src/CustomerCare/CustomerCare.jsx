          ...
          <div className="flex gap-10 max-md:grid max-md:gap-5">
            ...
            <div className="w-[70%] max-md:w-[100%]">
              ...
              <p className="text-[1rem] text-gray-700 mb-5">
                ...
                finibus in grav ida sed, blandit nec elit. Pellentesque lobortis
                tempus tincidunt. Nullam finibus sem eu pulvinar ultri cies.
                Donec in velit et diam aliquet mollis. Nulla facilisi. Fusce
              ...
              <div className="flex max-md:grid gap-10 text-[1.3rem] text-gray-600 max-md:mb-5">
                <div>
                  ...
                  <h1 className="flex items-center gap-3">
                    <BsArrowRightCircle className="bg-yellow-300 rounded-[100%] text-white text-[1.5rem]" />
                    Nulla facilisii primis neclaoreet
                  </h1>
                  <h1 className="flex items-center gap-3">
                    <BsArrowRightCircle className="bg-yellow-300 rounded-[100%] text-white text-[1.5rem]" />{" "}
